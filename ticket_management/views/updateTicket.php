...
require_once __DIR__ .'/../process/processUpdateTicket.php';
?>
...
<head>
    ...
    <title>Update Ticket #<?php echo $ticketId; ?> - Ticket Management</title>
...
<body class="body-image">
    ...
    <div class="tickets-container">
        <div class="tickets-header">
            <h1>Update Ticket #<?php echo $ticketId; ?></h1>
            <span class="ticket-created-date">Created: <?php echo $ticket->getCreatedAt()->format('M d, Y H:i'); ?></span>
        </div>
        ...
        <form method="POST" action="updateTicket.php?id=<?php echo $ticketId; ?>" class="ticket-form" style="border-radius: 0px 0px 8px 8px;">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="device_type_id" id="device_type_id" required>
                            ...
                            <?php foreach ($deviceTypes as $type): ?>
                                <option value="<?php echo $type->getId(); ?>" <?php echo ($device->getDeviceTypeId() == $type->getId()) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="external_uid" id="external_uid" placeholder="Enter device serial number" value="<?php echo htmlspecialchars($device->getExternalUid()); ?>" required>
                    </div>
                </div>
            </div>
                        ...
                        <select name="client_id" id="client_id">
                            ...
                            <?php foreach ($clients as $c): ?>
                                <option value="<?php echo $c->getId(); ?>" 
                                        data-search="<?php echo htmlspecialchars(strtolower($c->getFullName() . ' ' . $c->getPhoneNumber() . ' ' . $c->getEmail())); ?>"
                                        <?php echo ($client && $client->getId() == $c->getId()) ? 'selected' : ''; ?>>
                                    <?php echo htmlspecialchars($c->getFullName()); ?> - <?php echo htmlspecialchars($c->getPhoneNumber()); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
            ...
            <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <select name="priority_id" id="priority_id" required>
                            ...
                            <?php foreach ($priorities as $priority): ?>
                                <option value="<?php echo $priority->getId(); ?>" <?php echo ($ticket->getPriorityId() == $priority->getId()) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_id" id="status_id" required>
                            ...
                            <?php foreach ($statuses as $status): ?>
                                <option value="<?php echo $status->getId(); ?>" <?php echo ($ticket->getTicketStatusId() == $status->getId()) ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <select name="assigned_to" id="assigned_to">
                        ...
                        <?php foreach ($allUsers as $user): ?>
                            <option value="<?php echo $user->getId(); ?>" <?php echo ($ticket->getAssignedTo() == $user->getId()) ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" rows="5" placeholder="Describe the issue in detail..." required><?php echo htmlspecialchars($ticket->getDescription()); ?></textarea>
                </div>
            </div>

            <!-- Ticket Metadata Section -->
            <div class="form-section ticket-metadata">
                <h2 class="section-title">Ticket Information</h2>
                <div class="metadata-grid">
                    <div class="metadata-item">
                        <span class="metadata-label">Ticket ID:</span>
                        <span class="metadata-value">#<?php echo $ticketId; ?></span>
                    </div>
                    <div class="metadata-item">
                        <span class="metadata-label">Created At:</span>
                        <span class="metadata-value"><?php echo $ticket->getCreatedAt()->format('M d, Y H:i'); ?></span>
                    </div>
                    <div class="metadata-item">
                        <span class="metadata-label">Last Updated:</span>
                        <span class="metadata-value"><?php echo $ticket->getUpdatedAt()->format('M d, Y H:i'); ?></span>
                    </div>
                    <?php if ($ticket->getAssignedUserEmail()): ?>
                    <div class="metadata-item">
                        <span class="metadata-label">Currently Assigned To:</span>
                        <span class="metadata-value"><?php echo htmlspecialchars($ticket->getAssignedUserEmail()); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
